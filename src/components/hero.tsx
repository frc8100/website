...
export const Hero: React.FC = () => {
    return (
        <div className="top-0 z-10 flex h-screen w-full flex-col items-center justify-center bg-secondary-light">
            ...
            <button className="hover:bg-accent mt-6 rounded-lg bg-accent px-4 py-2 text-white transition-all duration-300">
                Get Started
            </button>
        </div>
    );
